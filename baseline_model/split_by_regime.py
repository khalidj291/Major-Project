...
def split_by_regime(processed_path=os.path.join(PROJECT_ROOT, "data", "data_processed.csv")):
    ...
    volatile.to_csv(os.path.join(PROJECT_ROOT, "data", "data_volatile.csv"), index=False)
    stable.to_csv(os.path.join(PROJECT_ROOT, "data", "data_stable.csv"), index=False)
    neutral.to_csv(os.path.join(PROJECT_ROOT, "data", "data_neutral.csv"), index=False)
