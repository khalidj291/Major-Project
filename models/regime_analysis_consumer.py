...
with open(os.path.join(SCRIPT_DIR, "model_baseline_consumer.pkl"), "rb") as f:
...
results_df.to_csv(os.path.join(PROJECT_ROOT, "results", "regime_analysis_consumer.csv"), index=False)
...
plt.tight_layout()
plt.savefig(os.path.join(PROJECT_ROOT, "results", "regime_sensitivity_chart_consumer.png"), dpi=150)
